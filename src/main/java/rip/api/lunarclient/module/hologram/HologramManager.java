package rip.api.lunarclient.module.hologram;

import lombok.Getter;
import lombok.Setter;
import rip.api.lunarclient.LunarClientAPI;
import rip.api.lunarclient.listener.HologramListener;
...
public class HologramManager {
    ...
    public HologramManager(){
        ...
        LunarClientAPI.getInstance().getServer().getPluginManager().registerEvents(new HologramListener(), LunarClientAPI.getInstance());
    }
